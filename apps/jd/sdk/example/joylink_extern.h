...
#define JLP_UUID_LEN   (32)
#define JLP_SOFT_SSID_LEN   (64)
#define JLP_CID_LEN   (32)
#define JLP_BRAND_LEN   (32)
#define JLP_CLOUD_PUB_KEY_LEN   (256)
#define JLP_CLOUD_PRI_KEY_LEN   (256)

typedef struct{
  char jlp_uuid[JLP_UUID_LEN];
  char jlp_soft_ssid[JLP_SOFT_SSID_LEN];
  char jlp_cid[JLP_CID_LEN];
  char jlp_brand[JLP_BRAND_LEN];
  char jlp_cloud_pub_key[JLP_CLOUD_PUB_KEY_LEN];
  char jlp_cloud_pri_key[JLP_CLOUD_PRI_KEY_LEN];
} user_dev_info_t; 


#ifdef JOYLINK_SDK_EXAMPLE_TEST
#define JLP_UUID "363282" 
#define JLP_SOFT_SSID "martin" 
#define JLP_CID "25"
#define JLP_BRAND "45"
#define IDT_CLOUD_PUB_KEY "0283866FBE020E880A0D004C7253A5FED07EBEEB618DB4149098F98ED8E5CEF244"
#define IDT_CLOUD_PRI_KEY "27D28D565044CA01618B83287FAD42DDCD69F23604089FB1F586D0FF00A2A0CE"
...
#elif defined(CONFIG_JD_FREERTOS_PAL)/* 默认使用海尔灯 */
//此处以下代码可暂时保留，便于对比参考分析，后续可删掉
// #define JLP_SOFT_SSID "JDDeng8400"
// #define JLP_CID "102009"
// #define JLP_BRAND "2"
// #if defined(CONFIG_BLE_JD_ADAPTER)
// #define JLP_UUID "B3F2BE"
// #define IDT_CLOUD_PUB_KEY "02E45E228937266E8C7CA8AB71743A9ECA682C1A65510DF796F4154D04A53376E8"
// #define IDT_CLOUD_PRI_KEY "58B110C4B09AF1E4F6E2D8213207009123D82061050A3B4F70E0F7A69AF37563"
// #else
// // #define JLP_UUID "015E91"
// #define IDT_CLOUD_PUB_KEY "027B7B1C1994FDDF870E7AFA35E314FA874B69E6E20DFB99DACEE88E63F1087307"
// #define IDT_CLOUD_PRI_KEY "5D542CC27D2C3A325CF5740D0AC0CDD15003345B9656ABEB78F27E519CE2787B"
// #endif
...
#define USER_DATA_MODE   "Mode"
#define USER_DATA_STATE   "State"
#define USER_DATA_BRIGHTLED   "BrightLED"
#define USER_DATA_COLOR   "Color"

typedef struct _user_dev_status_t {
    int Power;
    int Mode;
    int State;
    int BrightLED_old; //保存上一次亮度值，当pwm控灯失败，将亮度回拨
    int BrightLED;
    int Color_old;
    int Color;
} user_dev_status_t;
...
#else
#define JLP_UUID ""
#define JLP_SOFT_SSID ""
#define JLP_CID ""
#define JLP_BRAND ""
#define IDT_CLOUD_PUB_KEY ""
#define IDT_CLOUD_PRI_KEY ""
