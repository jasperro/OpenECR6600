...
#ifndef BOOTLOADER_BUILD
#define ESP_LOGE( tag, format, ... ) system_printf(tag, format, ##__VA_ARGS__)
#define ESP_LOGW( tag, format, ... ) system_printf(tag, format, ##__VA_ARGS__)
#define ESP_LOGI( tag, format, ... ) system_printf(tag, format, ##__VA_ARGS__)
#define ESP_LOGD( tag, format, ... ) system_printf(tag, format, ##__VA_ARGS__)
#define ESP_LOGV( tag, format, ... ) system_printf(tag, format, ##__VA_ARGS__)
#else
/**
